...
import com.POSD.Win8View.Win8View;
import com.POSD.Win8View.Win8View.OnViewClickListener;
import com.POSD.controllers.Version;
...
public class ApiDemosMainActivity extends Activity implements
	...
	private ArrayList<HashMap<String, Object>> getData() {
		...
		addItem(myData,
				...
				new Intent(this, N20PINPadControllerActivity.class));
...
//					dialog.show();
					...
					Intent intent = new Intent(ApiDemosMainActivity.this,N20PINPadControllerActivity.class);
					startActivity(intent);
